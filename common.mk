...
PRODUCT_COPY_FILES += \
    ...
    vendor/lineage/configs/etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml:$(TARGET_COPY_OUT_SYSTEM)//etc/permissions/vendor.lineage.biometrics.fingerprint.inscreen.xml
